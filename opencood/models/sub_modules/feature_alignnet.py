...
from opencood.models.sub_modules.feature_alignnet_modules import SCAligner, Res1x1Aligner, \
    Res3x3Aligner, Res3x3Aligner, CBAM, ConvNeXt, FANet, SDTAAgliner, SimpleMLP
...
class AlignNet(nn.Module):
    def __init__(self, args):
        ...
        if model_name == "scaligner":
            ...
            self.channel_align = SimpleMLP(args['args'])
        else:
            raise ValueError(f"Unknown aligner model name: {model_name}")
