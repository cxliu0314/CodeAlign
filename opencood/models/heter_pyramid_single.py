...
class HeterPyramidSingle(nn.Module):
    def __init__(self, args,train_flage=None):
        ...
        self.fix_modules = ['fusion_backbone', 'cls_head', 'reg_head', 'dir_head']
        ...
        """
        self.fusion_backbone = PyramidFusion(args['fusion_backbone'])
        """
    ...
    def forward(self, data_dict):
        ...
        # multiscale fusion. 
        feature, occ_map_list = self.fusion_backbone.forward_single(feature)
