...
def visualize(infer_result, 
        ...
        if method == 'bev':
            ...
            if pcd_modality is not None:
                ...
                color_map = {1: np.array([165, 59, 158]),     # 紫色
                                2: np.array([38, 158, 2]),    # 绿色
                                3: np.array([180, 123, 51]),  # 棕色
                                4: np.array([30, 88, 145]),   # 蓝色
                                5: np.array([123, 62, 220]),  # 紫蓝色
                                6: np.array([255, 100, 10]),  # 橙色
                                7: np.array([128, 128, 128]), # 灰色
                                8: np.array([255, 0, 0]),     # 红色
                                9: np.array([255, 255, 0]),   # 黄色
                                10: np.array([0, 255, 255])}   # 青色)}
            ...
            if infer_result is not None:
                ...
                if agent_modality_list is not None:
                    ...
                    for i, modality_name in enumerate(agent_modality_list):
                        ...
                        render_dict = {'m1': 'A1', 'm2':"A2", 'm3':'A3', 'm4':'A4','m5': 'A5', 'm6':"A6", 'm7':'A7', 'm8':'A8'}
